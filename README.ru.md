...
3. **Решающий Фильтр**: Прорыв должен быть ≥ 3 пипсов (избегает ложных прорывов)
...
| Сессия заканчивается | Автозакрытие |
| Прибыль ≥ 5p | Переместить SL на breakeven |
| Прибыль ≥ 10p | Trail SL 5p |
| Откат ≥ порога | Автозакрытие |
...
| Min Decisive Breakout | 3.0 пипсов | Сила прорыва |

#### Управление Выходом
| Параметр | По Умолчанию | Описание |
|----------|--------------|----------|
| Flat Threshold | 0.01 | Плоскость TDI |
| Breakeven Trigger | 5.0 пипсов | Прибыль для перемещения SL |
| Trail Trigger | 10.0 пипсов | Прибыль для начала trailing |
| Trail Distance | 5.0 пипсов | Расстояние SL от цены |

#### Сессия
| Параметр | По Умолчанию | Описание |
|----------|--------------|----------|
| Session Start Hour | 7 (UTC) | Открытие Лондона |
| Session End Hour | 16 (UTC) | Закрытие Лондона |
| Opening Range | 15 min | Окно расчета OR |

#### Защитные Механизмы
| Параметр | По Умолчанию | Описание |
|----------|--------------|----------|
| Min SL | 3.0 пипсов | Минимальный стоп-лосс |
| Max SL | 30.0 пипсов | Максимальный стоп-лосс |
